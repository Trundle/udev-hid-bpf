 ...
 * string has a date suffix, e.g. HUION_T21k_221229
 */
	...
	CollectionApplication(
		...
		CollectionPhysical(
			...
			PushPop(
				...
				LogicalMinimum_i16(0)
				LogicalMaximum_i16(0xac00)
				PhysicalMinimum_i16(0)
				PhysicalMaximum_i16(221)
				// Bytes 2/3 in report
				Usage_GD_X
				Input(Var|Abs)
				LogicalMinimum_i16(0)
				LogicalMaximum_i16(0x6b00)
				PhysicalMinimum_i16(0)
				PhysicalMaximum_i16(138)
				// Bytes 4/5 in report
				Usage_GD_Y
				Input(Var|Abs)
			)
